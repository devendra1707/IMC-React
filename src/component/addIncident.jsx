...
export function AddIncident() {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      enterpriseOrGovernment: yup
        .string()
        .required("Enterprise type must be required..."),
      ...
      <div className="row d-flex justify-content-center align-items-center vh-100">
        <div className="col-sm-6">
          <div className="card  p-4 shadow" id="doctorRegister">
            <h3 className="text-center fw-bold bg-light" id="registerHeading">
              Incident Details !!!
            </h3>
            <hr />
            <form onSubmit={formik.handleSubmit}>
              <div className="d-flex flex-row">
                <div className="form-floating me-2 flex-grow-1">
                  ...
                  />
                  <label htmlFor="enterpriseOrGovernment">
                    Enterprice Type
                  </label>
                  {formik.touched.enterpriseOrGovernment &&
                  formik.errors.enterpriseOrGovernment ? (
              ...
              <div className="form-floating flex-grow-1 mt-2">
                ...
                {formik.touched.incidentDetails &&
              ...
              <div className="d-flex row-flex mt-2">
                <div className="form-floating me-2 flex-grow-1">
                  ...
                  {formik.touched.reportedDateTime &&
                  formik.errors.reportedDateTime ? (
                    <div className="text-danger">
                      {formik.errors.reportedDateTime}
                    </div>
                  ) : null}
                ...
                <div className="form-group form-floating me-2 flex-grow-1 position-relative">
                  <select
                    id="priority"
                    name="priority"
                    className="form-control"
